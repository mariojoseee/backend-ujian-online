        ...
        <div class="col-12">
          ...
          <div class="card">
            ...
            <div class="card-body mr-1">
              ...
              <form method="post" action="/guru/{{ Auth::guard('guru')->user()->id }}">
                @method('put')
                @csrf
                <div class="mb-3">
                  <label for="nuptk" class="form-label">Nomor Unik Pendidik dan Tenaga Kependidikan (NUPTK)</label>
                  <input type="text" class="form-control @error('nuptk') is-invalid @enderror" id="nuptk" name="nuptk" value="{{ Auth::guard('guru')->user()->nuptk }}" />
                  @error('nuptk')
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control @error('email') is-invalid @enderror" id="email" name="email" value="{{ Auth::guard('guru')->user()->email }}" />
                  @error('email')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control @error('no_telp') is-invalid @enderror" id="no_telp" name="no_telp" value="{{ Auth::guard('guru')->user()->no_telp }}" />
                  @error('no_telp')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
